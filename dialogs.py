...
class PreferenceDialog(QDialog):
    ...
    def __build_ui__(self):
        ...
        self.audio_direction_cb = QComboBox()
        self.audio_direction_cb.addItems(['Increase', 'Decrease'])
        self.audio_direction_cb.setEnabled(False)
        self.audio_gb_layout.addWidget(self.audio_direction_cb, 0, 1, 1, 1)
        self.audio_label = QLabel('audio volume by ')
        self.audio_gb_layout.addWidget(self.audio_label, 0, 2, 1, 1)
        self.audio_slider = QSlider(Qt.Horizontal)
        self.audio_slider.setEnabled(False)
        self.audio_slider.setMinimum(5)
        self.audio_slider.setMaximum(100)
        self.audio_slider.setValue(5)
        ...
        self.audio_gb_layout.addWidget(self.audio_slider, 1, 0, 1, 3)
    ...
    def __manage_widgets__(self):
        ...
        if self.sender() == self.audio_level_cb:
            ...
            if self.audio_level_cb.isChecked():
                self.audio_direction_cb.setEnabled(True)
    ...
    def showDialog(cls, parent):
        ...
        return {'Output Folder': dialog.output_folder_le.text(),
                ...
                'Audio Level': {'Checked': dialog.audio_level_cb.isChecked(),
                                'Direction': dialog.audio_direction_cb.currentText(),
