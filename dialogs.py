...
class PreferenceDialog(QDialog):
    ...
    def __build_ui__(self):
        ...
        self.layout.addWidget(self.retain_audio_cb, 2, 0, 1, 1, Qt.AlignTop)
        ...
        self.layout.addWidget(self.audio_level_cb, 2, 1, 1, 1, Qt.AlignTop)
        ...
        self.layout.addWidget(self.audio_slider, 3, 1, 1, 1, Qt.AlignTop)
        self.slider_le = QLineEdit()
        self.slider_le.setText('5%')
        self.slider_le.setFixedWidth(40)
        self.slider_le.setEnabled(False)
        self.layout.addWidget(self.slider_le, 3, 2, 1, 1, Qt.AlignTop)
        ...
        self.layout.addWidget(self.bnw_cb, 5, 0, 1, 1, Qt.AlignTop)
        self.stablization_cb = QCheckBox('Enable Stablization')
        self.layout.addWidget(self.stablization_cb, 5, 1, 1, 1, Qt.AlignTop)

        self.compression_label = QLabel('\nCompression\nNote: more compression leads to small video size\nand lower video quality.')
        self.layout.addWidget(self.compression_label, 6, 0, 1, 2, Qt.AlignTop)
